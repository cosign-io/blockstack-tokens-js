...
describe('Token/Token', () => {
  ...
  describe('bindings', () => {
    ...
    describe('invocation', () => {
      ...
      it('dist', () => {
        console.log();
        var signer = new Token(ABI_DIST).distribution(3, 0, ['e10f3d125e5f4c753a6456fc37123cf17c6900f2000000000000000000000000', Token.concat(ADDR, 32000).toString('hex')]);
        console.log(signer.body);
        var sig = signer.sign(SIGNER);
      });

      it('settl', () => {
        console.dir(Token.separate('f3beac30c498d9e26865f34fcaa57dbb935b0d74000000000000000000050000'));
      ...
      it('bet', () => {
        ...
        console.log(signer.body);
        var sig = signer.sign(SIGNER);
        console.log(Token.parseToHex(sig));
      });
